"""
Django settings for host_file project.
...
SECRET_KEY = 'django-insecure-_ehn5_1k0pxw#!kj_q-=4l0=(14xdn!mos%!z^e&a8360j!q7@'
...
WSGI_APPLICATION = 'host_file.wsgi.application'
...
SOCIALACCOUNT_PIPELINE = (
    ...
    'allauth.socialaccount.pipeline.user',
    'allauth.socialaccount.pipeline.save_profile',
)
